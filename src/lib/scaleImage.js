export default function downScaleImage(img, scale) {
...
// scales the canvas by (float) scale < 1 returns a new canvas containing the
// scaled image.
function downScaleCanvas(cv, scale) {
    ...
    // weight is weight of current source point within target. next weight is weight
    // of current source point within next target's point.
